...
export const POSTS_CLEAR = 'POSTS/POSTS_CLEAR';
...
export const TASK_ADD = 'TASKS/TASK_ADD';
export const TASK_COMPLETE = 'TASKS/TASK_COMPLETE';
export const TASK_INCOMPLETE = 'TASKS/TASK_INCOMPLETE';
export const TASK_DELETE = 'TASKS/TASK_DELETE';